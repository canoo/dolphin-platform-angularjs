...
# Dolphin Platform AngularJS client API [![Build Status](https://travis-ci.org/canoo/dolphin-platform-angularjs.svg?branch=master)](https://travis-ci.org/canoo/dolphin-platform-angularjs)
